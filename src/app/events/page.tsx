...
export default function EventsIndexPage() {
  ...
  useEffect(() => {
    ...
    if (!loading && selectedCommunity) {
      // Redirect to the selected community's events page
      router.push(`/${selectedCommunity.name}/events`);
    }
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh]">
      ...
      <p className="mt-4 text-gray-600">Redirecting to community events...</p>
    </div>
  );
} 